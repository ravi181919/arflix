...
const Trailer = () => {
  ...
  return (
    <div className="absolute z-10 top-0 left-0 h-screen flex flex-col items-center justify-center w-screen bg-black/90">
        ...
        <h1 className="font-bold leading-none tracking-wider text-6xl text-center text-red-500">404</h1>
        <p className="text-md mt-3 text-zinc-200">Sorry, trailer is not available !</p>
        </div >
      )}
    </div>
  );
